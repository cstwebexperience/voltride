...
export const COUNTRIES = [
  { code: "de", name: "Germany",        g: 0, lang: "de" },
  { code: "fr", name: "France",         g: 2, lang: "fr" },
  { code: "it", name: "Italy",          g: 5, lang: "it" },
  { code: "es", name: "Spain",          g: 3, lang: "es" },
  { code: "nl", name: "Netherlands",    g: 1, lang: "nl" },
  { code: "be", name: "Belgium",        g: 1, lang: "nl" },
  { code: "at", name: "Austria",        g: 2, lang: "de" },
  { code: "pl", name: "Poland",         g: 6, lang: "pl" },
  { code: "ro", name: "Romania",        g: 4, lang: "ro" },
  { code: "cz", name: "Czech Republic", g: 3, lang: "cs" },
  { code: "dk", name: "Denmark",        g: 2, lang: "da" },
  { code: "se", name: "Sweden",         g: 4, lang: "sv" },
  { code: "fi", name: "Finland",        g: 4, lang: "fi" },
  { code: "ie", name: "Ireland",        g: 4, lang: "en" },
  { code: "gr", name: "Greece",         g: 4, lang: "el" },
  { code: "hu", name: "Hungary",        g: 4, lang: "hu" },
  { code: "lu", name: "Luxembourg",     g: 1, lang: "fr" },
  { code: "ee", name: "Estonia",        g: 4, lang: "et" },
  { code: "lv", name: "Latvia",         g: 4, lang: "lv" },
  { code: "lt", name: "Lithuania",      g: 4, lang: "lt" },
  { code: "si", name: "Slovenia",       g: 4, lang: "sl" },
  { code: "li", name: "Liechtenstein",  g: 4, lang: "de" },
];
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    specs: { Motor: "48 V · 250 / 500 W", Battery: "48 V · 18.2 Ah", Range: "60–80 km", "Top speed": "25 km/h", Display: "Full-colour TFT", Brakes: "Front & rear hydraulic disc", Tyres: "20 × 4.0 fat", Smart: "TFT · NFC · APP · Anti-loss (Find My) · Alarm", Extras: "Throttle, front rack, rear seat", Weight: "43 kg net · 49.5 kg gross", Certified: "CE · EN 15194 · UKCA · RoHS" },
  ...
  },
  {
    ...
    specs: { Motor: "48 V · 250 / 500 / 750 W", Battery: "48 V · 15.6 Ah", Range: "50–60 km", "Top speed": "25 km/h", Frame: "Reinforced steel", Brakes: "Front & rear hydraulic disc", Tyres: "20 × 4.0 fat", Extras: "Rear seat", Weight: "43 kg net · 51 kg gross", Certified: "CE · EN 15194 · UKCA · RoHS" },
